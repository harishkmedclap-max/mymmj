  ...
  return (
    <section className="w-full bg-[#0d2e2a] py-16 px-4">
      <div className="max-w-3xl mx-auto flex flex-col items-center text-center gap-6">
        ...
        <p className="text-muted-inv max-w-lg">
          Licensed physicians offer secure online consultations to guide patients through
          the evaluation process with care and confidence.
        </p>

        <div className="flex flex-wrap justify-center gap-3">
          <a href="#apply"
            className="inline-flex items-center gap-2 border border-white/50 text-white text-sm font-semibold px-5 py-2.5 rounded-md hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-[#0d2e2a] transition-colors">
